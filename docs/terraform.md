...
|------|-------------|------|---------|:--------:|
| <a name="input_additional_security_groups"></a> [additional\_security\_groups](#input\_additional\_security\_groups) | List of custom created security group IDs to be allowed to connect to the cluster. | `list(string)` | `<list>` | no |
| <a name="input_create_default_iam_role"></a> [create\_default\_iam\_role](#input\_create\_default\_iam\_role) | Whether to create a default access role | `bool` | `true` | no |
